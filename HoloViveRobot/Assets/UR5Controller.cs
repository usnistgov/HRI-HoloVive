...
public class UR5Controller : MonoBehaviour {
    ...
    public void setJointValues(float[] input)
    {
        jointValues = input;
    }
    ...
    void OnGUI() {
        ...
        if (TextToggle.isOn) {
            float[] offsetValues = offsetSliderValues();
            /*var temp = "";
    ...
    public float[] offsetSliderValues() {
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            {
                case 0:
                    tempVal = -1f * (sliderList[i].value + 45f);
                    break;
                case 1:
                    tempVal = sliderList[i].value - 90f;
                    break;
                case 3:
                    tempVal = sliderList[i].value - 90f;
                    break;
                case 4:
                    tempVal = -1f * sliderList[i].value;
                    break;
                default:
